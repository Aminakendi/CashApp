...
void main() {
  ...
  test('KCB test withdrawal', () {
    final sms = "UIDFY61EB3 Confirmed. You have transfered Ksh1,000.00 from your KCB M-PESA account on 13/9/26 at 4:20 PM. KCB M-PESA Account balance is Ksh0.29. New M-PESA balance is Ksh1,011.42.";
    final parsed = MpesaParser.parse(sms);
    print(parsed);
  });
}
