...
class $BudgetNotificationsTable extends BudgetNotifications
    with TableInfo<$BudgetNotificationsTable, BudgetNotification> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $BudgetNotificationsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, categoryId, yearMonth, threshold, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'budget_notifications';
  @override
  VerificationContext validateIntegrity(Insertable<BudgetNotification> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  @override
  BudgetNotification map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $BudgetNotificationsTable createAlias(String alias) {
    return $BudgetNotificationsTable(attachedDatabase, alias);
  }
}

class BudgetNotification extends DataClass
    implements Insertable<BudgetNotification> {
  final int id;
  final int categoryId;
  ...
  BudgetNotificationsCompanion toCompanion(bool nullToAbsent) {
    return BudgetNotificationsCompanion(
      id: Value(id),
      categoryId: Value(categoryId),
  ...
  BudgetNotification copyWithCompanion(BudgetNotificationsCompanion data) {
    return BudgetNotification(
      id: data.id.present ? data.id.value : this.id,
      categoryId:
          data.categoryId.present ? data.categoryId.value : this.categoryId,
  ...
  @override
  String toString() {
    return (StringBuffer('BudgetNotification(')
          ..write('id: $id, ')
          ..write('categoryId: $categoryId, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, categoryId, yearMonth, threshold, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is BudgetNotification &&
          other.id == this.id &&
          other.categoryId == this.categoryId &&
...
class BudgetNotificationsCompanion extends UpdateCompanion<BudgetNotification> {
  final Value<int> id;
  final Value<int> categoryId;
  final Value<String> yearMonth;
  final Value<int> threshold;
  final Value<DateTime> createdAt;
  const BudgetNotificationsCompanion({
    this.id = const Value.absent(),
    this.categoryId = const Value.absent(),
  ...
  BudgetNotificationsCompanion.insert({
    ...
    this.createdAt = const Value.absent(),
        ...
        yearMonth = Value(yearMonth),
        threshold = Value(threshold);
  static Insertable<BudgetNotification> custom({
    Expression<int>? id,
    Expression<int>? categoryId,
  ...
  BudgetNotificationsCompanion copyWith(
      {Value<int>? id,
      Value<int>? categoryId,
  ...
  @override
  String toString() {
    return (StringBuffer('BudgetNotificationsCompanion(')
          ..write('id: $id, ')
          ..write('categoryId: $categoryId, ')
          ..write('yearMonth: $yearMonth, ')
          ..write('threshold: $threshold, ')
...
typedef $$UnparsedMessagesTableProcessedTableManager = ProcessedTableManager<
    ...
    UnparsedMessage,
    PrefetchHooks Function()>;
typedef $$BudgetNotificationsTableCreateCompanionBuilder
    = BudgetNotificationsCompanion Function({
  Value<int> id,
  required int categoryId,
  required String yearMonth,
  required int threshold,
...
typedef $$BudgetNotificationsTableUpdateCompanionBuilder
    = BudgetNotificationsCompanion Function({
  Value<int> id,
  Value<int> categoryId,
  Value<String> yearMonth,
...
class $$BudgetNotificationsTableFilterComposer
    extends Composer<_$AppDatabase, $BudgetNotificationsTable> {
  $$BudgetNotificationsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$BudgetNotificationsTableOrderingComposer
    extends Composer<_$AppDatabase, $BudgetNotificationsTable> {
  $$BudgetNotificationsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$BudgetNotificationsTableAnnotationComposer
    extends Composer<_$AppDatabase, $BudgetNotificationsTable> {
  $$BudgetNotificationsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$BudgetNotificationsTableTableManager extends RootTableManager<
    _$AppDatabase,
    ...
    $$BudgetNotificationsTableOrderingComposer,
    $$BudgetNotificationsTableAnnotationComposer,
    $$BudgetNotificationsTableCreateCompanionBuilder,
    $$BudgetNotificationsTableUpdateCompanionBuilder,
    (
      BudgetNotification,
      BaseReferences<_$AppDatabase, $BudgetNotificationsTable,
          BudgetNotification>
    ),
    BudgetNotification,
    PrefetchHooks Function()> {
  $$BudgetNotificationsTableTableManager(
      _$AppDatabase db, $BudgetNotificationsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$BudgetNotificationsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$BudgetNotificationsTableOrderingComposer(
                  $db: db, $table: table),
          createComputedFieldComposer: () =>
...
typedef $$BudgetNotificationsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $BudgetNotificationsTable,
    BudgetNotification,
    $$BudgetNotificationsTableFilterComposer,
